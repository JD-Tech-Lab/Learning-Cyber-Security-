# 📡 Networking Topology – Star Topology Lab Setup

## 📌 Project Title

Basic Star Network Topology Implementation

## 📖 Description

This project demonstrates a simple **Star Topology** network setup used in LAN environments.
In this topology, all devices are connected to a central switch.

Star topology is commonly used in:
...
## 🖥️ Network Diagram (Logical Representation)
...
1. All PCs connect to the central switch using Ethernet cables.
2. The switch manages data forwarding between devices.
3. The router connects the LAN to the Internet.
4. If one PC fails, other devices continue working.
5. If the switch fails, the entire network goes down.
...
* Scalable (add more devices easily)
...
* More cable required
* Slightly higher cost than Bus topology
